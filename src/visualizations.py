...
def create_matplotlib_figure(technology_counts: dict[str, int]) -> Figure:
    ...
    axes[0, 0].set_title("Horizontal bar chart", fontweight="bold", color="white")
    ...
    axes[0, 1].set_title("Vertical bar chart", fontweight="bold", color="white")
    ...
    axes[1, 0].set_title("Line chart", fontweight="bold", color="white")
...
def create_seaborn_figure(date_summary: pd.DataFrame) -> Figure:
    ...
    axes[1, 0].set_title("3. Single session in every days of week", color="white")
